...
let HomePage = class HomePage {
    constructor(facebook, loadingController, router, platform, alertController, http, storage, toastController, menu, https, services) {
    ...
    Login() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.services.Login(this.email, this.password).subscribe(res => {
