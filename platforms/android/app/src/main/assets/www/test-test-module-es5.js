...
var TestPage = /** @class */ (function () {
    function TestPage(http, abiliti, modalCtrl, router, zone, geolocation, loadingCtrl) {
        this.http = http;
    ...
    TestPage.prototype.ngOnInit = function () {
        var _this = this;
        this.abiliti.getAbilities().subscribe(function (res) {
            var _a;
            // console.log(res);
            (_a = _this.habilidades).push.apply(_a, res.abilities);
            console.log(_this.habilidades);
    ...
    TestPage.prototype.test = function () {
    ...
    TestPage.prototype.changeListener = function ($event) {
        this.file = $event.target.files[0];
        console.log(this.file);
    };
    TestPage.prototype.onFileSelected = function (event) {
        this.selectedFile = event.target.files[0];
        console.log(this.selectedFile);
    };
    TestPage.prototype.onUpload = function () {
        var fb = new FormData();
        ...
        this.http.post("https://api.haskyconnections.com/auth/user/document", fb, axiosConfig).subscribe(function (res) {
            console.log(res);
        });
    };
    TestPage.prototype.modal = function () {
    ...
    TestPage.prototype.hola = function () {
        this.router.navigate(["/code"]);
    };
    TestPage.prototype.evento = function (event) {
        console.log(event);
    };
    TestPage.prototype.tryGeolocation = function () {
        var _this = this;
