...
var SignupPage = /** @class */ (function () {
    function SignupPage(storage, formBuilder, toastController, menu, services, router) {
        ...
        this.storage.get("language").then(function (res) {
            if (res === "es") {
                fetch("../../../assets/language.json")
                    ...
                    .then(function (json) {
                    _this.language = json.es[0].signup[0];
            ...
            if (res === "en") {
                fetch("../../../assets/language.json")
                    .then(function (res) { return res.json(); })
                    .then(function (json) {
                    _this.language = json.en[0].signup[0];
                    _this.error_messages = json.en[0].error_messages[0];
    ...
    SignupPage.prototype.save = function () {
        ...
        if (this.singup.value.password != this.singup.value.passwordR) {
            ...
            this.services.singup(this.singup.value.firstname, this.singup.value.lastname, this.singup.value.email, this.singup.value.password, this.singup.value.passwordR, this.singup.value.phone).subscribe(function (res) {
                _this.storage.set("token", {
                    token: res.access_token,
                    user: res.user.id
                }).then(function () {
                    _this.storage.set("validate", "no").then(function () {
    ...
    SignupPage.prototype.presentToastError = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    SignupPage.prototype.click = function () {
        this.router.navigate(["/code"]);
    };
    SignupPage.prototype.viewPassword = function () {
        if (this.valor == 0) {
            this.password = "text";
            this.valor = 1;
        }
    ...
    SignupPage.prototype.viewPassword2 = function () {
        if (this.valor2 == 0) {
            this.password2 = "text";
            this.valor2 = 1;
        }
