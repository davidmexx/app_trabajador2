...
let TradesPageModule = class TradesPageModule {
};
...
let TradesPage = class TradesPage {
    constructor(services, storage, loadingController, router, toastController, menu, modal, alertController) {
    ...
    getTrades() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.services.getTrades().subscribe(res => {
    ...
    getEspeciality() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.presentLoading(loading);
            yield this.services.getEspeciality().subscribe(res => {
...
//# sourceMappingURL=pages-trades-trades-module-es2015.js.map